        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Add New</h5>
                <form action="/admin/author/add" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="position-relative form-group"><label for="title" >Author Title</label><input name="title" id="title" type="text" class="form-control"></div>
                    ...
                    <div class="position-relative form-group"><label for="bio" >Author's Bio</label><textarea name="bio" id="bio" class="form-control" rows="10"></textarea></div>
